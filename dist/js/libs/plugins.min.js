...
!function(e,n,t){"object"==typeof module&&module&&"object"==typeof module.exports?module.exports=t:(e[n]=t,"function"==typeof define&&define.amd&&define(n,[],function(){return t}))}(this,"jRespond",function(e,n,s){"use strict";return function(e){var c=[],d=[],i=e,a="",h="",n=0,t=500,o=function(e){var n=e.breakpoint,t=e.enter||s;c.push(e),d.push(!1),p(n)&&(t!==s&&t.call(null,{entering:a,exiting:h}),d[c.length-1]=!0)},r=function(){for(var e=[],n=[],t=0;t<c.length;t++){var i=c[t].breakpoint,o=c[t].enter||s,r=c[t].exit||s;"*"===i?(o!==s&&e.push(o),r!==s&&n.push(r)):p(i)?(o===s||d[t]||e.push(o),d[t]=!0):(r!==s&&d[t]&&n.push(r),d[t]=!1)}for(var u={entering:a,exiting:h},f=0;f<n.length;f++)n[f].call(null,u);for(var l=0;l<e.length;l++)e[l].call(null,u)},p=function(e){if("object"==typeof e){if(0<=e.join().indexOf(a))return!0}else{if("*"===e)return!0;if("string"==typeof e&&a===e)return!0}},u=function(){var e="number"!=typeof window.innerWidth?0!==document.documentElement.clientWidth?document.documentElement.clientWidth:document.body.clientWidth:window.innerWidth;e!==n?(t=100,function(e){for(var n=!1,t=0;t<i.length;t++)if(e>=i[t].enter&&e<=i[t].exit){n=!0;break}n&&a!==i[t].label?(h=a,a=i[t].label,r()):n||""===a||(a="",r())}(e)):t=500,n=e,setTimeout(u,t)};return u(),{addFunc:function(e){!function(e){if(e.length===s)o(e);else for(var n=0;n<e.length;n++)o(e[n])}(e)},getBreakpoint:function(){return a}}}}(0,this.document));
!function(p,t){"use strict";p.fn.minimap=function(t){var g=this,w=p(window),y=!0,o={heightRatio:.6,widthRatio:.05,offsetHeightRatio:.035,offsetWidthRatio:.035,position:"right",touch:!0,smoothScroll:!0,smoothScrollDelay:200,onPreviewChange:function(){},disableFind:!1},R=p.extend({},o,t),h=["right","left"];jQuery.fn.disableFind=function(){return this.each(function(){for(var t="",o=!1,e=p(this),i=e.html(),n=0;n<i.length;n++)t+=i[n],"<"===i[n]&&(o=!0),">"===i[n]&&(o=!1),!1===o&&(t+='<span style="position:absolute; right:-999999999px;">.</span>')," "===i[n]&&(t+=" ");e.html(t)})};var i=function(t,o){switch(t){case"disableFind":if(1!=o&&0!=o)throw"Invalid disableFind: "+o;break;case"heightRatio":var e=o;if(!p.isNumeric(e)||e<=0||1<e)throw"Invalid heightRatio: "+e;break;case"widthRatio":var i=o;if(!p.isNumeric(i)||i<=0||.5<i)throw"Invalid widthRatio: "+i;break;case"offsetHeightRatio":var n=o;if(!p.isNumeric(n)||n<0||.9<n)throw"Invalid offsetHeightRatio: "+n;break;case"offsetWidthRatio":var a=o;if(!p.isNumeric(a)||a<0||.9<a)throw"Invalid offsetWidthRatio: "+a;break;case"position":var s=o.toLowerCase();if(-1===h.indexOf(s))throw"Invalid position: "+R.position;R.position=s;break;case"smoothScrollDelay":if((0|o)!==o||o<4)throw"Invalid smoothScrollDelay(in ms): "+o;break;case"touch":case"smoothScroll":break;case"onPreviewChange":var r=o;if(!r||!p.isFunction(r))throw"Invalid onPreviewChange: "+o;break;default:throw"Invalid validation property: "+t}};for(var e in R)i(e,R[e]);var l=g.clone();l.find(".minimap.noselect").remove(),l.find(".miniregion").remove(),l.addClass("minimap noselect"),!0===R.disableFind&&l.children().each(function(){p(this).addClass("unsearchable")}),l.children().each(function(){p(this).css({"pointer-events":"none"})});var b=p('<div class="miniregion"> </div>');p(p("body")[0]).append(b),p(p("body")[0]).append(l),p(".unsearchable").disableFind();var x=function(){return{x:w.width()/g.width()*R.widthRatio,y:w.height()/g.height()*R.heightRatio}},n=function(t){if(y){var o=x(),e="scale("+o.x+","+o.y+")",i=w.height()*R.offsetHeightRatio,n=w.width()*R.offsetWidthRatio,a=g.height()*(o.y-1)/2+i,s=g.width()*(o.x-1)/2+n,r={"-webkit-transform":e,"-moz-transform":e,"-ms-transform":e,"-o-transform":e,transform:e,top:a,width:w.width()*(1/o.x)*R.widthRatio,height:w.height()*(1/o.y)*R.heightRatio,margin:"0px",padding:"0px"};r[R.position]=s,l.css(r);var h=g.offset().top*o.y,c={width:l.width()*o.x,height:w.height()*o.y,margin:"0px",top:w.scrollTop()*o.y+i-h+"px"};c[R.position]=n+"px",b.css(c),R.onPreviewChange(l,o)}},a=function(t){if(y){var o=x(),e=w.height()*R.offsetHeightRatio,i=g.offset().top*o.y,n=b.outerHeight(!0),a=(t.clientY-n/2-e+i)/o.y;if("click"===t.type&&R.smoothScroll){var s=w.scrollTop(),r=g.outerHeight(!0),h=s<(a=Math.max(a,Math.min(a,r))),c=R.smoothScrollDelay,l=Math.abs(s-a),d=c/l,f=1,u=4;4<=d?u=parseInt(f):f=1<=d?4*parseInt(d):4/d;var v=s,m=parseInt(l/f);k=!0;var p=window.setInterval(function(){v+=h?f:-f,--m<=0&&(clearInterval(p),k=!1,v=a),w.scrollTop(v)},u)}else w.scrollTop(a);t.stopPropagation()}},s=!1,k=!1,r=function(t){s=!1,g.removeClass("noselect"),b.removeClass("dragging")},c=function(t){s&&!k&&a(t)},d=function(t){a(t),s=!1},f=function(t){s=!0,g.addClass("noselect"),b.addClass("dragging")};n(),w.on("resize",n),w.on("scroll",function(t){if(y){var o=x(),e=w.height()*R.offsetHeightRatio,i=g.offset().top*o.y,n=w.scrollTop()*o.y,a=b.outerHeight(!0),s=g.outerHeight(!0)*o.y+i;n+a+e<i||s<n?b.css({display:"none"}):b.css({top:n+e-i+"px",display:"block"})}}),p(document).on("mouseup",r),p(document).on("mousemove",c),p(b).on("mousedown",f),p(b).on("mouseup",r),p(b).on("mousemove",c),p(b).on("click",d),p(l).on("mousedown",f),p(l).on("mouseup",r),p(l).on("mousemove",c),p(l).on("click",d);var u="",v=function(t){var o=t.changedTouches;if(!(1<o.length)){var e=o[0],i=["touchstart","touchmove","touchend"],n=i.indexOf(t.type);if(-1!==n){var a=["mousedown","mousemove","mouseup"][n];t.type===i[2]&&u===i[0]&&(a="click");var s=document.createEvent("MouseEvent");s.initMouseEvent(a,!0,!0,window,1,e.screenX,e.screenY,e.clientX,e.clientY,!1,!1,!1,!1,0,null),e.target.dispatchEvent(s),t.preventDefault(),u=t.type}}};R.touch&&(document.addEventListener("touchstart",v,!0),document.addEventListener("touchmove",v,!0),document.addEventListener("touchend",v,!0),document.addEventListener("touchcancel",v,!0));var m=function(o,e){return function(t){i(o,t),R[o]=t,e&&n()}};return p.extend({},this,{setPosition:function(t){var o=R.position;if(i("position",t),o!==R.position){var e={};e[o]="",n(),b.css(e),l.css(e)}},setHeightRatio:m("heightRatio",!0),setWidthRatio:m("widthRatio",!0),setOffsetHeightRatio:m("offsetHeightRatio",!0),setOffsetWidthRatio:m("offsetWidthRatio",!0),setSmoothScroll:m("smoothScroll"),setSmoothScrollDelay:m("smoothScrollDelay"),show:function(){y||(l.show(),b.show(),y=!0,n())},hide:function(){y&&(l.hide(),b.hide(),y=!1)},toggle:function(){l.toggle(),b.toggle(),(y=!y)&&n()}})}}(jQuery);